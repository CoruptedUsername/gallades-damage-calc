...
const IF: TypeChart = extend(true, {}, SV, {
  ...
  Grass: {Lemon: 1, Silly: 2, Friend: 1},
  Fire: {Lemon: 1, Silly: 1, Friend: 1},
  Water: {Lemon: 0.5, Silly: 1, Friend: 1},
  Electric: {Lemon: 1, Silly: 0.5, Friend: 1},
  Ice: {Lemon: 0.5, Silly: 1, Friend: 1},
  Flying: {Lemon: 1, Silly: 1, Friend: 1},
  Bug: {Lemon: 2, Silly: 2, Friend: 1},
  Poison: {Lemon: 2, Silly: 1, Friend: 1},
  Ground: {Lemon: 0.5, Silly: 1, Friend: 1},
  Rock: {Lemon: 2, Silly: 1, Friend: 1},
  Fighting: {Lemon: 1, Silly: 1, Friend: 1},
  Psychic: {Lemon: 2, Silly: 1, Friend: 1},
  Ghost: {Lemon: 1, Silly: 0.5, Friend: 1},
  Dragon: {Lemon: 1, Silly: 1, Friend: 1},
  Dark: {Lemon: 1, Silly: 0.5, Friend: 1},
  Steel: {Lemon: 0.5, Silly: 1, Friend: 1},
  Fairy: {Lemon: 1, Silly: 1, Friend: 1},
  Stellar: {Lemon: 1, Silly: 1, Friend: 1},
  Lemon: {
    '???': 1,
    Normal: 1,
    Grass: 1,
...
export const TYPE_CHART = [CHAMPIONS, RBY, GSC, ADV, DPP, BW, XY, SM, SS, SV, RBY, BW, SV, SV, SV,
  SV, SV, SV, SV, SV, SV, SV, XY, IF, SV, SV, SV, SV]; // NewGenChange
